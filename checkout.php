                    ...
                    <div class="col-md-4">
                        <div class="order-details">
                            ...
                            <div class="order-details__item">
                             ...
                             <div class ="ordre-details__total bilinfo coupon_style" id="coupon_box">
                                <h5>Coupon Value</h5>
                            ...
                            <div class="ordre-details__total bilinfo coupon_style">
                                <input id="coupon_str" type="textbox" class="coupon_style mr5">
