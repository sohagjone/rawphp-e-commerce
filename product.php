...
<img src="<?php echo PRODUCT_IMAGE_SITE_PATH.$get_product['0']['image'] ?>" alt="full-image">
                    ...
                    <h2><?php echo $get_product['0']['name'] ?></h2>
                                ...
                                <div class="ht__pro__desc">
                                    <div class="sin__desc">
    <?php  $productSoldQtyByProductId = productSoldQtyByProductId($con, $get_product['0']['id']);

        $pending_qty = $get_product['0']['id']-$productSoldQtyByProductId;
 
        $cart_show = 'yes';
        if($get_product['0']['id']>$productSoldQtyByProductId){
            $stock = 'In Stock';
        }else{
            $stock = 'Not In Stock';
            $cart_show = '';
...
<li><a href="categories.php?id=<?php echo $list['id'] ?>"><?php echo $get_product['0']
['categories']?></a></li>
                                        </ul>
                                    </div>
                                     <?php if( $cart_show!= ''){ ?>
